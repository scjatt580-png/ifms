...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-8">
        ...
        <div class="px-8 pb-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 font-medium uppercase tracking-widest mt-1">Organization: <?= htmlspecialchars($user['organization_name'] ?? 'N/A') ?></p>
                <p class="text-sm text-gray-400 font-medium mt-1"><?= htmlspecialchars($user['designation'] ?? 'Contact') ?></p>
            </div>
            ...
            <form id="profile-form" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-50">
                ...
                <div>
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2 px-1">Organization</label>
                    <input type="text" value="<?= htmlspecialchars($user['organization_name'] ?? 'N/A') ?>" readonly class="w-full bg-gray-100 border-none rounded-xl px-4 py-3 text-sm font-bold text-gray-500 cursor-not-allowed">
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        <a href="projects.php" class="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all hover:border-indigo-300 group cursor-pointer">
            ...
            <p class="text-xs text-gray-500 mt-1">View active projects</p>
        </a>

        <a href="billing.php" class="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all hover:border-emerald-300 group cursor-pointer">
            ...
            <h3 class="text-sm font-bold text-gray-900 group-hover:text-emerald-600">Invoices</h3>
            <p class="text-xs text-gray-500 mt-1">View billing information</p>
        </a>

        <a href="tickets.php" class="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all hover:border-purple-300 group cursor-pointer">
            <div class="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center mb-4 group-hover:bg-purple-100 transition-colors">
                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m-4 0v2m4 0a1 1 0 11-2 0m2 0a1 1 0 10-2 0m-4 0v2m-4 0a1 1 0 11-2 0m2 0a1 1 0 10-2 0M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
            </div>
            <h3 class="text-sm font-bold text-gray-900 group-hover:text-purple-600">Support Tickets</h3>
            <p class="text-xs text-gray-500 mt-1">View support requests</p>
        </a>
    </div>
</div>
